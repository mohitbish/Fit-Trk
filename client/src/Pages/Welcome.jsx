...
const Welcome = () => {
  ...
  return (
    <div className="w-full h-screen bg-[#202124]">
      ...
      <div className=" w-full  flex flex-col sm:flex-row space justify-between px-5 sm:px-10 py-10 sm:py-15 my-10 text-white ">
        <div>
